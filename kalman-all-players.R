...
#Aim: Modeling football trajectories for 22 players plus ball

#Brief description:
#1. Modeling dynamics of all 22 players and the ball by building state space models based on Newtonian 
#   mechanics.
#2. For computational simplicity, players and ball move according to their own state space equations 
#   that do not inetract with each other. 
#3. Reproduces Figure 6 in the paper.
